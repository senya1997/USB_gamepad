...
#define  USB_CFG_VENDOR_ID       0xea, 0x1d
...
#define  USB_CFG_DEVICE_ID       0x07, 0x10
 ...
 */
#define USB_CFG_VENDOR_NAME     'S', 'S'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     's', 's', '_', 'g', 'a', 'm', 'e', 'p', 'a', 'd'
#define USB_CFG_DEVICE_NAME_LEN 10
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USB-IDs-for-free.txt before you assign a name if
 * you use a shared VID/PID.
 */
/*#define USB_CFG_SERIAL_NUMBER   'N', 'o', 'n', 'e' */				// serial number needed ???
